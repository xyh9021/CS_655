 ...
 * Date: 10/12/2024
 * File Name: FreelanceVan.java
 * Description: This class represents freelance van driver.
 */
...
/**
 * The FreelanceVan class represents freelance van driver.
 * It implements the DeliveryAbility interface, allowing it to
 * manage shops and process delivery requests.
 */
public class FreelanceVan implements DeliveryAbility {
  ...
  /**
   * Constructor for FreelanceVan.
   * @param name The name of the van driver
   */
  public FreelanceVan(String name) {
    this.name = name;
    this.carType = "FreelanceVan";
